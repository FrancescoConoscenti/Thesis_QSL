...
if __name__ == "__main__":
    ...
    Delta1 = 0.8    # d_{x^2-y^2} pairing, 1st neighbors
    ...
    print("\nDone. For full VMC optimization, plug gutzwiller_amplitude() and")
    print("local_energy_heisenberg() into a Metropolis sampler + SR optimizer.")
