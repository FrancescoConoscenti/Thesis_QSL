...
def main():
    ...
    plot_entropy_vs_partition_variance(L=8, n_seeds=10, n_samples=65536, models_to_plot=["ViT", "HFDS", "HFDS Random"], variances=[5e-4, 1e-3, 2.5e-3, 5e-3, 7.5e-3, 1e-2,2.5e-2, 5e-2, 7.5e-2, 1e-1, 1, 10, 100], partition_type="Square")
