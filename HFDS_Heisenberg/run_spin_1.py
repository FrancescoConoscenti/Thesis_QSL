...
from HFDS_Heisenberg.HFDS_model_spin_1 import HiddenFermion
...
dtype   = "real"
MFinitialization = "Fermi"#random #Fermi #G_MF
...
model_name = f"layers{hid_layers}_hidd{n_hid_ferm}_feat{features}_sample{n_samples}_lr{lr}_iter{N_opt}_parity{parity}_rot{rotation}_trans{translation}_Init{MFinitialization}+random_type{dtype}_1"
