...
from HFDS_Heisenberg.HFDS_model_spin_6 import HiddenFermion
...
model_name = f"layers{hid_layers}_hidd{n_hid_ferm}_feat{features}_sample{n_samples}_lr{lr}_iter{N_opt}_symm{symmetry}_Init{MFinitialization}_type{dtype}_6"
