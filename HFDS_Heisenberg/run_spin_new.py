...
from HFDS_Heisenberg.HFDS_model_spin_new import Orbitals
from HFDS_Heisenberg.HFDS_model_spin_new_1 import HiddenFermion_new_1
...
model = HiddenFermion_new_1(n_elecs=n_elecs,
                   network="FFNN",
                   n_hid=n_hid_ferm,
                   Lx=L,
                   Ly=L,
