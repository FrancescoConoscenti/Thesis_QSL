...
model_ViT = f"/scratch/f/F.Conoscenti/Thesis_QSL/ViT_Heisenberg/plot/layers2_d16_heads2_patch2_sample1024_lr0.0075_iter100"
model_HFDS = f"/scratch/f/F.Conoscenti/Thesis_QSL/HFDS_Heisenberg/plot/spin/layers1_hidd16_feat64_sample2048_lr0.02_iter200"
...
for model_name in [model_ViT, model_HFDS]:
    ...
    # Title and grid
    plt.title("Error and Fidelity vs J")
    fig.tight_layout()
