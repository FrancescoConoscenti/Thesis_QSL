...
def avarage_plots_seeds(folder, Js):
    ...
    for J in Js:
        ...
        Plot_Sign_Fidelity(sign_vstate_full_mean, sign_exact_full_mean, fidelity_mean, folder_to_plot, one_avg= "avg")
        Plot_Sign_single_config(configs, sign_vstate_config_mean, sign_vstate_full_mean, sign_exact_full_mean, weight_exact_mean, weight_vstate_mean, 5, folder_to_plot, one_avg= "avg")
        Plot_Weight_single(configs, sign_vstate_config_mean, weight_exact_mean, weight_vstate_mean, 5, folder_to_plot, one_avg = "avg")
        Plot_MSE_configs(error_mean, folder_to_plot, one_avg = "avg")
        Plot_Sign_Err_Amplitude_Err_Fidelity(error_mean, fidelity_mean, sign_vstate_full_mean, sign_exact_full_mean, folder_to_plot, one_avg = "avg")
