...
def avarage_plots_seeds(folder, Js, plot_variance=True):
    ...
    for J in Js:
        ...
        Plot_Sign_Err_Amplitude_Err_Fidelity(amp_overlap_mean, fidelity_mean, sign_vstate_full_mean, folder_to_plot, one_avg = "avg", plot_variance=plot_variance, error_var=amp_overlap_var, fidelity_var=fidelity_var, sign_err_var=sign_err_var) # Existing call
...
if __name__ == "__main__":
    ...
    model_path = "/scratch/f/F.Conoscenti/Thesis_QSL/HFDS_Heisenberg/plot/spin_new/layers1_hidd2_feat2_sample1024_lr0.025_iter5_symmTrue_InitFermi_typereal"
    Js = [0.6]
